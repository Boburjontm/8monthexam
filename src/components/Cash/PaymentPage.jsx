...
const PaymentPage = () => {
  return (
    <div className="w-full max-w-[90%] md:max-w-[70%] lg:max-w-[60%] m-auto mb-[10%]">
      <h3 className="text-[#202020] mt-[8%] mb-[4%] text-[8vw] md:text-[4vw] font-medium leading-tight">
        Оплата
      </h3>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-[5%]">
        <div className="w-full lg:w-[30%] h-auto rounded-[10px] p-[5%] bg-white border border-[#E5E2EE] mb-[5%] lg:mb-0">
